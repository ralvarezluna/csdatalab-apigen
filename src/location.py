...
class ownLocation(datacatalogtordf.location.Location):
    ...
    def __init__(self, identifier: Optional[str] = None) -> None:
        ...
        self._g.bind("locn", "http://www.w3.org/ns/locn#geometry",override=True, replace=True)
        self._g.bind("geosparql", GEOSPARQL)

    @property
    def identifier(self: ownLocation) -> str:
        """Get/set for identifier."""
        return self._identifier

    @identifier.setter
    def identifier(self: ownLocation, identifier: str) -> None:
        self._identifier = URI(identifier)

    @property
    def geometry(self: ownLocation) -> str:
        """Get/set for geometry."""
        return self._geometry

    @geometry.setter
    def geometry(self: ownLocation, geometry: str) -> None:
        self._geometry = geometry

    @property
    def bounding_box(self: ownLocation) -> str:
        """Get/set for bounding_box."""
        return self._bounding_box

    @bounding_box.setter
    def bounding_box(self: ownLocation, bounding_box: str) -> None:
        self._bounding_box = bounding_box

    @property
    def centroid(self: ownLocation) -> str:
        """Get/set for centroid."""
        return self._centroid

    @centroid.setter
    def centroid(self: ownLocation, centroid: str) -> None:
        self._centroid = centroid

    # -
    def to_rdf(
        self: ownLocation, format: str = "turtle", encoding: Optional[str] = "utf-8"
    ) -> bytes:
    ...
    # -
    def _to_graph(self: ownLocation) -> Graph:
    ...
    # -
    def _geometry_to_graph(self: ownLocation) -> None:
    ...
    def _bounding_box_to_graph(self: ownLocation) -> None:
    ...
    def _centroid_to_graph(self: ownLocation) -> None:
